    ...
    return (
        <section className="py-16 px-4" id="cartera">
            <div className="container mx-auto">
                <h2 className="text-3xl font-bold text-center mb-8 text-black">Películas en Cartelera</h2>
                ...
                >
                    {movies.map((movie) => (
                        <SwiperSlide key={movie.id} className="max-w-xs rounded-lg overflow-hidden">
                            <div className="relative group">
                                ...
                                <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 rounded-lg">
                                    ...
                                    <p className="text-gray-300 text-sm mb-2 justify-around"> {movie.overview} </p> 
